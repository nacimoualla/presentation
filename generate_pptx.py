...
def add_styled_slide(title_text, bullet_points):
    ...
    # We must set the text first before styling it!
...
add_styled_slide("La Synchronisation 🛡️", [
...
style_shape(slide.placeholders[1], font_size=28, color=TEXT_COLOR)


prs.save("presentation.pptx")
print("PowerPoint presentation generated successfully with Dracula styling!")
